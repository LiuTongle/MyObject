...
// Logger.getLogger(String.valueOf(MessageController.class));
//
// @Autowired
// private IMessageService iMessageService;
//
// @RequestMapping(value = "/getMessages", produces = "text/json;
...
// @ApiParam(name = "type", value = "0:系统消息,1:个人消息")
...
// }
// List<Message> messages = iMessageService.getMessagesByUserAndType(userId,
// type, userType, start, offset, receivedIds);
