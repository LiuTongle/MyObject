...
// Logger.getLogger(String.valueOf(UserController.class));
//
// @Autowired
...
// if (userEntity.getUserImToken() == null ||
// userEntity.getUserImToken().trim().equals("")) {
// String jsonString = HttpRequestUtil.neteaseIm(userEntity.getUserCellphone());
...
// userEntity.setUserImToken(connectionToken);
...
// @ApiImplicitParam(name = "tokenType", value = "tokenType", required = true,
// dataType = "string", paramType = "header"), })
// public @ResponseBody String logout(@CurrentUser User currentUser) {
// RequestManager requestManager = new RequestManager();
// JSONObject result = new JSONObject();
// try {
...
// } else {
// if (iVerifyCodeService.useVerifyCode(cellphone, verifyCode, 0)) {
// }
// User user = iUserService.registerUser(null, password, cellphone);
// result = JSONObject.fromObject(user);
// // String param =
// // "id="+user.getUserId()+"&cellphone="+cellphone+"&password="+password;
// //
// HttpRequestUtil.sendGet("http://122.114.52.243:8088/publicCAS/user/patient/sync",
// // param);
// }
// } catch (Exception e) {
// requestManager.putErrorMessage(e.getMessage());
...
// @ApiImplicitParam(name = "tokenType", value = "tokenType", required = true,
// dataType = "string", paramType = "header"), })
// public @ResponseBody String resetPassword(@RequestParam(value = "cellphone",
// required = false) String cellphone,
// @RequestParam(value = "password", required = false) String password,
// @RequestParam(value = "verifyCode", required = false) Integer verifyCode) {
// RequestManager requestManager = new RequestManager();
...
// }
//
// @RequestMapping(value = "/getUserInfo", produces = "text/json;
// charset=utf-8", method = { RequestMethod.POST,
// RequestMethod.GET })
// // @Authorization
...
// @ApiImplicitParam(name = "tokenType", value = "tokenType", required = true,
// dataType = "string", paramType = "header"), })
// public @ResponseBody String getUserInfo(@CurrentUser User currentUser) {
// RequestManager requestManager = new RequestManager();
// JSONObject result = new JSONObject();
// try {
...
// }
//
// @RequestMapping(value = "/updateUserInfo", produces = "text/json;
// charset=utf-8", method = { RequestMethod.POST,
// RequestMethod.GET })
// // @Authorization
...
// @ApiImplicitParam(name = "tokenType", value = "tokenType", required = true,
// dataType = "string", paramType = "header"), })
// public @ResponseBody String updateUserInfo(@CurrentUser User currentUser,
...
// @RequestParam(value = "userCertificateType", required = false) Integer
// userCertificateType,
// @RequestParam(value = "userCertificateDetail", required = false) String
...
// (!userCertificateDetail.trim().equals(""))) {
...
// }
//
// @RequestMapping(value = "/updateUserCellphone", produces = "text/json;
// charset=utf-8", method = {
...
// @ApiImplicitParam(name = "tokenType", value = "tokenType", required = true,
// dataType = "string", paramType = "header"), })
// public @ResponseBody String updateUserCellphone(@CurrentUser User
// currentUser,
// @RequestParam(value = "verifyCode", required = false) Integer verifyCode,
...
// }
//
// @RequestMapping(value = "/updateUserHeadImage", produces = "text/json;
// charset=utf-8", method = {
// RequestMethod.POST, RequestMethod.GET })
// // @Authorization
...
// @ApiImplicitParam(name = "tokenType", value = "tokenType", required = true,
// dataType = "string", paramType = "header"), })
// public @ResponseBody String updateUserHeadImage(@CurrentUser User
// currentUser,
...
// currentUser.getUserToken() + "/" + filename;
